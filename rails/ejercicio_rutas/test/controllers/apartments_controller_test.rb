...
class ApartmentsControllerTest < ActionController::TestCase
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post :create, apartment: { edifice_id: @apartment.edifice_id, floor: @apartment.floor, name: @apartment.name }
    end
  ...
  test "should update apartment" do
    patch :update, id: @apartment, apartment: { edifice_id: @apartment.edifice_id, floor: @apartment.floor, name: @apartment.name }
    assert_redirected_to apartment_path(assigns(:apartment))
  end
